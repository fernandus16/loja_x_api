...
def get_produto(query: ProdutoBuscaSchema):
    """Faz a busca por um Produto a partir do nome do produto ignorando case.
    ...
    session = Session()
    # fazendo a busca
    minha_query = session.query(Produto).filter(Produto.nome.ilike(produto_nome))
    produto = minha_query.first()
